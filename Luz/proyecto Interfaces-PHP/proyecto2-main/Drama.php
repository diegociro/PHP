...
$materiales = $db->getGenerosParejas('drama');
?>
...
<head>
    ...
    <link rel="stylesheet" href="estilos_drama.css">
    <title>Drama</title>
...
<body>
   <!-- menu despleglable -->
    ...
    <nav class="menu" id="menu">
      ...
      <section>
        <div><p class="titulos_libros">Drama</p></div>
    ...
    <div class="caja-flor">
       <img src="imagenes/mascaras_color.png" alt="decoracion">
    </div>
