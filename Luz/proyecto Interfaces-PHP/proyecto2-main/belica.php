...
$materiales = $db->getGenerosParejas('belica');
?>
...
<head>
    ...
    <link rel="stylesheet" href="estilos_belica.css">
    <title>Bélica</title>
...
<body>
   <!-- menu despleglable -->
    ...
    <nav class="menu" id="menu">
      ...
      <section>
        <div><p class="titulos_libros">Bélica</p></div>
    ...
    <div class="caja-flor">
       <img src="imagenes/guerra-mundial.png" alt="decoracion">
    </div>
