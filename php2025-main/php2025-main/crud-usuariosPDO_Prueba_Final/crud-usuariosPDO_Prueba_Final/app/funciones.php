...
/**
 * Los paréntesis en tuser[] hace que automáticamente PHP 
 * construya un array con los distintos valores del checkbox
 * Si no lo ponemos habría que poner un nombre diferente para
 * cada checkbox
 */
