...
$materiales = $db->getGenerosParejas('cienfi');
?>
...
<head>
    ...
    <link rel="stylesheet" href="estilos_cienciaFiccion.css">
...
<body>
   <!-- menu despleglable -->
    ...
    <a href="iniciar_sesion/login/login.php?logout=1">Cerrar Sesión</a><!--metemos un 1 por poner algo para que acceda--> 
      ...
      <section>
        <div><p class="titulos_libros">Ciencia Ficción</p></div>
    ...
    <div class="caja-flor">
       <img src="imagenes/cienciaficcion.png" alt="decoracion">
    </div>
