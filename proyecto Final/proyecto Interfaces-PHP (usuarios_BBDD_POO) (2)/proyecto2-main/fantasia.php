...
$materiales = $db->getGenerosParejas('fantasia');
?>
...
<head>
    ...
    <link rel="stylesheet" href="estilos_fantasia.css">
    <title>Romance</title>
...
<body>
   <!-- menu despleglable -->
    ...
    <a href="iniciar_sesion/login/login.php?logout=1">Cerrar Sesión</a><!--metemos un 1 por poner algo para que acceda--> 
      ...
      <section>
        <div><p class="titulos_libros">Fantasía</p></div>
    ...
    <div class="caja-flor">
       <img src="imagenes/espada_color.png" alt="decoracion">
    </div>
