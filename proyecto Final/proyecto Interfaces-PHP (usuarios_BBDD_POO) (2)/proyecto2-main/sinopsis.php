...
<section class="fondobanners">
 ...
 <div class="banners"> <a href="romancepareja.php?id=<?php echo $idEnlace; ?>"> <!-- obtenemos el enlace para que la foto esta hipervinculada -->
<img class="fotosResultado" src="<?php echo $obraresu->imagen; ?>" alt="<?php echo $obraresu->titulo; ?>">
     </a>
    <div class="descvalorados"> 
      <p><?php echo $obraresu->tipo . " - " . $obraresu->anio; ?></p>
